    ...
    return (
        <>
            ...
            <p>Métricas de Cobros por Semana</p>
                ...
                <div className="text-lg bg-gray-200 font-bold mb-2 grid grid-cols-8 border p-2 rounded-lg shadow-md">            
                <div className="col-end-1">
                    ...
                    <label className="ml-2">Fecha Fin: </label>
                    <input
                        type="date"
                        value={endDate}
                        onChange={handleEndDateChange}
                        className="p-2 ml-2 w-36 border rounded"
                    />
                </div>
