...
export const GenerarP1 = (doc, contrato, conductor, vehiculo, propietario) => {
    ...
    posY = agregarDeclaracionEnLinea(
        `1. Ser persona de nacionalidad mexicana o extranjero con permiso de trabajo y residencia, acreditando su identidad con el documento oficial {bold}${propietario.nombreDocumento.toUpperCase()}{/bold} número: {bold}${propietario.nroDocumento.toUpperCase()}{/bold}.`,
        posY + 10
    );
