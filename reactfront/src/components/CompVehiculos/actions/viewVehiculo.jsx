...
const URI_CONDUCTORES = 'http://localhost:8000/conductores'; // Asegúrate de que este endpoint exista
const URI_PROPIETARIOS = 'http://localhost:8000/propietarios'; // Asegúrate de que este endpoint exista
      ...
      >
        <div className="relative bg-white rounded-lg p-6 w-full max-w-2xl items-start mt-10 mb-8">
          ...
          <div>
            ...
            <p><strong>Numero de Serie:</strong> {vehiculo.numeroSerie}</p>
